...
{
    public class EnemyStrikeParticle : Particle
    {
        //Mostly used by future clone to look pretty gamer

        private Color Col;
        private Enemy ConnectedEnemy;
        public EnemyStrikeParticle(Vector2 pos, SceneManager sceneman, Color col,Enemy enemy) : base(pos, sceneman)
        {
            Pos = pos;
            SceneMan = sceneman;
        ...
        {
            sb.Draw(ConnectedEnemy.SprOutline, new Rectangle((int)(Pos.X), (int)(Pos.Y), (int)ConnectedEnemy.WidthHeight.X, (int)ConnectedEnemy.WidthHeight.Y), new Rectangle(0, 0, (int)ConnectedEnemy.WidthHeight.X, (int)ConnectedEnemy.WidthHeight.Y), new Color(Col.R / 255 * (TimeSinceCreation * 4), Col.G / 255 * (TimeSinceCreation * 4), Col.B / 255 * (TimeSinceCreation * 4), Col.A / 255 * (TimeSinceCreation * 4)), 0f, new Vector2(0, 0), SpriteEffects.None, 0.6f);

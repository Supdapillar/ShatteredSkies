...
{
    /*public class LazerBulletAlly : Bullet
    {
        private int ShotDirection;
        private double ShotDelay = 2;
        public LazerBulletAlly(int subtype, Vector2 pos, Vector2 D, SceneManager sceneman, dynamic shotby) : base(subtype, pos, sceneman)
        {
            Pos = pos;
            Delta = D;
            SceneMan = sceneman;

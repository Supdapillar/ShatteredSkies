...
{
    public class Hurricane : EnemyBullet
    {

        private Vector2 Gotopos;


        public Hurricane(Vector2 PS, Vector2 D, Enemy shotBy, SceneManager Sceneman)
        {
            Pos = PS;
            Delta = D;
            SceneMan = Sceneman;
            WidthHeight = new Vector2(SceneMan.Textures["Hurricane"].Width, SceneMan.Textures["Hurricane"].Height);
            ShotBy = shotBy;
        ...
        public override void Draw(SpriteBatch sb)
        {
            ...
            sb.Draw(SceneMan.Textures["Hurricane"], new Rectangle((int)(Pos.X), (int)(Pos.Y), (int)WidthHeight.X, (int)WidthHeight.Y), new Rectangle(0, 0, (int)WidthHeight.X, (int)WidthHeight.Y), new Color(255, 255, 255), 0f, new Vector2(0, 0), SpriteEffects.None, 0.3f);
        }
    }
}
